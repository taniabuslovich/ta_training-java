package com.epam.training.student_tatsiana_mikhnavets.clean_code.Java.src.main.java;


import com.epam.training.student_tatsiana_mikhnavets.clean_code.Java.src.main.java.Planes.*;
...
public class Airport {
    ...
    if (plane.getPlanePurpose() == MilitaryPlaneTypes.TRANSPORT) {
    ...
    public List<MilitaryPlane> getBomberMilitaryPlanes() {
        ...
        List<MilitaryPlane> militaryPlanes = getMilitaryPlanes();
        for (MilitaryPlane plane : militaryPlanes) {
            if (plane.getPlanePurpose() == MilitaryPlaneTypes.BOMBER) {
