package com.epam.training.student_tatsiana_mikhnavets.java_basics.wrappers.battleship8x8;
...
public class Battleship8x8 {
        ...
        int digit0 = Integer.valueOf(String.valueOf(shot.charAt(1)), 10)-1;
        int digit1 = Integer.valueOf(String.valueOf(shot.charAt(0)), 18)-10;
        int digitOfShots = Integer.decode(0+ Integer.toString(digit0) + digit1);
