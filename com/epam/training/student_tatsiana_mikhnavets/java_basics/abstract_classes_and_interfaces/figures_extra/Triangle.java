...
public class Triangle extends Figure {
    ...
    public boolean isTheSame(Figure figure) {
        ...
        if(getClass() == figure.getClass() &&  areaDelta < ERROR_DELTA && centroidDeltaX < ERROR_DELTA && centroidDeltaY < ERROR_DELTA) return true;
        else return false;
    }


    private boolean nullCheck(){
        if(pointA != null && pointB != null && pointC != null) return true;
        else return false;
    }
